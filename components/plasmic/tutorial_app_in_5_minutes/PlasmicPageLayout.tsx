...
// Plasmic Project: fXaKtArraaVLjdAL6QzYET
// Component: 3ujWNOITIdH_
...
import projectcss from "./plasmic.module.css"; // plasmic-import: fXaKtArraaVLjdAL6QzYET/projectcss
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: 3ujWNOITIdH_/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: MB4Q5ilk02FU/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: iDpmU1yZCMzx/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg___6SUXx)}
          role={"img"}
        />
      }
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__urlx6)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__tKfHj)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__osinn)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__ak1Xx)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
